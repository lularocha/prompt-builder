...
export const translations = {
  ...
  pt: {
    ...
    "error.rateLimited":
      "Estamos recebendo muitas solicitações agora. Aguarde um momento e tente novamente.",
    "error.overloaded":
      "O serviço de IA está ocupado no momento. Tente novamente em instantes.",
    "error.config":
      "Desculpe, o serviço está indisponível. Tente novamente mais tarde.",

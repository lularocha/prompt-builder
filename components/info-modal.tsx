                ...
                >
                    ...
                    >
                        ...
                        <div className="space-y-4">
                            <div>
                                <h3 className="text-lg font-semibold mb-2 text-orange-500 pt-2">System Prompt</h3>
                                <p>
                            ...
                            <div>
                                <h3 className="text-lg font-semibold mb-2 text-orange-500 pt-2">User Prompt</h3>
                                <p>
                            ...
                            <div>
                                <h3 className="text-lg font-semibold mb-2 text-orange-500 pt-2">Learn by doing</h3>
                                <p className="mb-3">
